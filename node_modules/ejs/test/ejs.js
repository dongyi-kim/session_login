...
suite('include()', function () {
  ...
  test('include arbitrary files as-is', function () {
    var file = 'test/fixtures/include.js.ejs';
    assert.equal(ejs.render(fixture('include.js.ejs'), {pets: users}, {filename: file}),
        fixture('include.js.html'));
  });
...
suite('preprocessor include', function () {
  ...
  test('include arbitrary files as-is', function () {
    var file = 'test/fixtures/include_preprocessor.js.ejs';
    assert.equal(ejs.render(fixture('include_preprocessor.js.ejs'), {pets: users}, {filename: file}),
        fixture('include_preprocessor.js.html'));
  });
